...
class BackgroundImgImportPicker extends React.PureComponent {
  ...
  render() {
    const { backgroundImg, disabled } = this.state;
    ...
    return (
      <div className={`${selectorPrefix}`}>
        ...
        <div className={`${selectorPrefix}-Import`}>
          <SelectFile onSuccess={this.onSuccess} accept=".gif,.jpg,.jpeg,.png" multiple={false}>
            Import
          </SelectFile>
        </div>
        <div
